...
public class UserDao {
    ...
    public GetUserInfoRes getUsersByEmail(String email){
    ...
    public GetUserInfoRes getUsersByIdx(int userIdx){
    ...
    public int deleteUserByIdx(int userIdx){
        ...
        int deleteUserIdxParam = userIdx;
        return this.jdbcTemplate.update(deleteUserIdxQuery,deleteUserIdxParam);
    }
